...
function setmonth(inputObj,dateFormatStyle,beginDate,endDate,lang){
	if(null == inputObj){return null;}
	new Calendar(inputObj,dateFormatStyle,beginDate,endDate,1,"m").show();
}
...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendar {font-size:11px; margin:0;padding:0px;border:1px solid #397EAE;background-color:#DBE7F2;}";
