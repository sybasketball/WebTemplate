...
K.options = {
	...
	htmlTags : {
		...
		embed : ['id', 'class', 'src', 'width', 'height', 'type', 'loop', 'autostart', 'quality', '.width', '.height', 'align', 'allowscriptaccess','alt','title'],
...
function _mediaImg(blankPath, attrs) {
	...
	html += 'data-ke-tag="' + escape(srcTag) + '" alt="' + alt + '" title="' + title + '" />';
	return html;
}
...
* KindEditor - WYSIWYG HTML Editor for Internet
* Copyright (C) 2006-2011 kindsoft.net
* 2016-11-10 sunny 修改，添加了flash说明
* @author Roddy <luolonghao@gmail.com>
* @site http://www.kindsoft.net/
* @licence http://www.kindsoft.net/license.php
*******************************************************************************/
	...
	self.plugin.flash = {
		edit : function() {
			var html = [
                ...
                //描述
			    '<div class="ke-dialog-row">',
			    '<label for="keTitle" style="width:60px;">' + lang.flashTitle + '</label>',
			    '<input type="text" id="keTitle" class="ke-input-text" name="title" value="" style="width:200px;" />',
			    '</div>',
				'</div>'
			].join('');
			var dialog = self.createDialog({
			...
			if (img) {
				...
				titleBox.val(attrs.title || attrs.alt);
	...
	self.plugin.media = {
		edit : function() {
			var html = [
                ...
                //描述
			    '<div class="ke-dialog-row">',
			    '<label for="keTitle" style="width:60px;">' + lang.mediaTitle + '</label>',
			    '<input type="text" id="keTitle" class="ke-input-text" name="title" value="" style="width:200px;" />',
			    '</div>',
				//autostart
				'<div class="ke-dialog-row">',
