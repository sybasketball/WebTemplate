    ...
    public class DESEncrypt
    {
        ...
        public string EncryptString(string strContent)
        {
            ...
            catch
            {
                ...
                result = null;
                this.Logging("DES加密出错！", "EncryptString",strContent);
            }
            return result;
        }
        ...
        public string EncryptString_AsicII(string strContent)
        {
            ...
            {
                result = null;
                this.Logging( "AsicII加密出错！","EncryptString_AsicII",strContent);
            }
            return result;
        }
        ...
        public string DecryptString_AsicII(string strContent)
        {
            ...
            {
                this.Logging("AsicII解密出错！", "DecryptString_AsicII", strContent);
                result = null;
            }
            return result;
        ...
        public void EncryptFile(string filePath, string outPath)
        {
            ...
            if (isExist)//如果存在
            {
                ...
                {
                    this.Logging("File加密出错！", "EncryptFile", filePath + "\",\"" + outPath);
        ...
        public string DecryptString(string strContent)
        {
            ...
            if (!string.IsNullOrEmpty(strContent))
            {
                ...
                catch
                {
                    ...
                    //throw error;
                    result = null;
                    this.Logging("DES解密出错！", "DecryptString", strContent);
                }
            }
            return result;
        }
        ...
        public string DecryptString(byte[] toDecrypt)
        {
            ...
            {
                this.Logging("DES解密出错！", "DecryptString", toDecrypt.ToString());
                //throw new ApplicationException(err.Message);
            }
            finally
            {
        ...
        public void DecryptFile(string filePath, string outPath)
        {
            ...
            if (isExist)//如果存在
            {
                ...
                {
                    this.Logging("File解密出错！", "DecryptFile", filePath + "\",\"" + outPath);
                    //throw new ApplicationException(err.Message);
                }
                finally
                {
