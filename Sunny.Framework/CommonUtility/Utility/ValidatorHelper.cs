...
namespace CommonUtility.Utility
{
    public static class ValidatorHelper
    {
        ...
        {
            return ValidatorHelper.QuickValidate("^[1-9]*[0-9]*$", _value);
        }
        ...
        {
            return ValidatorHelper.QuickValidate("^[a-zA-Z0-9_]*$", _value);
        }
        ...
        {
            return ValidatorHelper.QuickValidate("^(0|([1-9]+[0-9]*))(.[0-9]+)?$", _value);
        }
        ...
        {
            if (_value != null && IsNumber(_value))
        ...
        /// <param name="_defaultValue">默认值</param>
        /// <returns></returns>
        public static float StrToFloat(string _value, float _defaultValue)
        {
            if (_value != null && IsNumber(_value))
        ...
        public static string ToStr(object val,string defaultStr)
        {
